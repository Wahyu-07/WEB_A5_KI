            ...
            <table className="w-full text-center border-collapse">
                <thead className="sticky top-0 z-20 shadow-sm">
                    <tr className="bg-gray-900 text-white text-xs font-bold uppercase tracking-wider">
                        <th className="px-6 py-4 text-left rounded-tl-xl">Nama Produk</th>
                ...
                <tbody className="divide-y divide-gray-100 text-sm">
                    {loading ? (
                        ...
                        <tr><td colSpan="4" className="px-6 py-10 text-center text-gray-500">Produk tidak ditemukan.</td></tr>
                            ...
                            <td className="px-6 py-4 text-center">
                                <div className="flex justify-center gap-2">
                                    <button 
                                        ...
                                        className="flex items-center gap-2 px-3 py-1.5 bg-amber-50 text-amber-700 hover:bg-amber-100 rounded-lg transition-colors font-bold text-xs border border-amber-200"
                                        title="Edit Menu"
                                    >
                                        <FaEdit /> Edit
                                    </button>
                                    <button 
                                        ...
                                        className="flex items-center gap-2 px-3 py-1.5 bg-red-50 text-red-700 hover:bg-red-100 rounded-lg transition-colors font-bold text-xs border border-red-200"
                                        title="Hapus Menu"
                                    >
                                        <FaTrash /> Hapus
                                    </button>
                ...
                >
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Lengkapi detail produk di bawah ini.</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="group">
                            <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 ml-1">Nama Produk</label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="group">
                                <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 ml-1">Harga (Rp)</label>
                            ...
                            <div className="group">
                                <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 ml-1">Stok Awal</label>
                                <input type="number" className="w-full bg-gray-50 border border-gray-200 p-3.5 rounded-xl font-medium focus:bg-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all"
                                    placeholder="0"
                        ...
                        <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-50">
                            ...
                            <button type="submit" className="px-6 py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-black shadow-lg hover:shadow-xl active:scale-95 transition-all">Simpan</button>
                        </div>
                    </form>
                </motion.div>
            </div>
